...
AdaptiveAvgPool2d_Backward::AdaptiveAvgPool2d_Backward(cudnnHandle_t handle, vector<double> &args, bool is_UVM) : 
...
AdaptiveAvgPool2d_Backward::~AdaptiveAvgPool2d_Backward() {
...
float AdaptiveAvgPool2d_Backward::Run() {
    if (is_UVM) {
