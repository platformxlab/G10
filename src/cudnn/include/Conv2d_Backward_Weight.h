...
class Conv2d_Backward_Weight : public Profiler {
    public:
        ...
        cudnnFilterDescriptor_t d_filter_descriptor;
        ...
        Conv2d_Backward_Weight(cudnnHandle_t handle, vector<double> &args, bool is_UVM);
