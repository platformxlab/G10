...
if selection == ACTIVE_NO_TOTAL:
    ...
    motiv1 = {"all" : live_sum, "weight" : live_weight}
...
#     ax.fill_between(np.arange(len(motiv1["all"])), motiv1["weight"], alpha=0.6, color=colors[1])
...
Figure.text(-0.15, 3.2, "Memory Consumption (Active)", rotation=90, \
